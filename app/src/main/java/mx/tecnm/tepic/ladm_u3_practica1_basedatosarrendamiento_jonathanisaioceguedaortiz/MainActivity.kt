...
import mx.tecnm.tepic.ladm_u3_practica1_basedatosarrendamiento_jonathanisaioceguedaortiz.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AlertDialog.Builder(this)
            ...
            "Para BUSCAR automoviles ingresar una marca, un modelo o un kilometraje a buscar, después dar click en el debido botón de"+
