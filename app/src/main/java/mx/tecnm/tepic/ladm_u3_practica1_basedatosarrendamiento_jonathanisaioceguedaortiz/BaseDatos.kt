...
class BaseDatos(
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("CREATE TABLE ARRENDAMIENTO (IDARRENDA INTEGER PRIMARY KEY AUTOINCREMENT, NOMBRE VARCHAR(20), DOMICILIO VARCHAR(50), LICENCIACOND VARCHAR(50)," +
                "IDAUTO INTEGER, FECHA DATE, FOREIGN KEY(IDAUTO) REFERENCES AUTOMOVIL(IDAUTO))")
    }
